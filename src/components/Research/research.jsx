...
She holds a Ph.D. in Information Science and an M.S. in Education Administration Policy from the State University of New York, Albany, as well as a Bachelor of Engineering in Mechanical Engineering from Beijing Jiaotong University​. Refer to <a href="https://wordpress.clarku.edu/jizhang/research/" target="_blank" rel="noopener noreferrer" style={{ color: '#007bff', textDecoration: 'none' }}>Professor Zhang's research page​</a> for more information.</p>
                            <br />
                        </Fade>
                    </div>
                    <div className='col-md-5'>
                ...
                <div className='row'>
                    <div className='col-md-7 mart-top'>
                        <Fade bottom duration={1000}>
                            ...
                            {/* <h2 style={{ lineHeight: '1.182em' }}>Biology Research</h2> */}
                            {/* <p><b>by Javir Tabima Restrepo | Tabima Lab</b></p> */}
                            <p style={{ textAlign: 'justify', marginTop:'20px', lineHeight: '1.667em', color: '#4b5b70', fontSize: '16px', fontWeight: '400' }}>Professor Chris Williams was known for his research in environmental science, particularly in the areas of forest ecology, carbon cycling, and climate change impacts on ecosystems. For the most current and detailed information about his research at Clark University, I recommend visiting the Clark University website, navigating to the Environmental Science department or related faculty pages, and looking for his profile or research page. There, you should find up-to-date information on his research interests, publications, and projects.  Refer to <a href="https://wordpress.clarku.edu/cwilliams/research/" target="_blank" rel="noopener noreferrer" style={{ color: '#007bff', textDecoration: 'none' }}>Professor Williams’s research page</a> for more information.</p>
                            <br />
                        </Fade>
                    </div>
                    <div className='col-md-5'>
                ...
                <div className='row'>
                    <div className='col-md-7 mart-top'>
                        <Fade bottom duration={1000}>
                            ...
                            {/* <h2 style={{ lineHeight: '1.182em' }}>Biology Research</h2> */}
                            {/* <p><b>by Javir Tabima Restrepo | Tabima Lab</b></p> */}
                            <p style={{ textAlign: 'justify', marginTop:'20px', lineHeight: '1.667em', color: '#4b5b70', fontSize: '16px', fontWeight: '400' }}>Professor Ulm is a Professor of the Practice and the Director of the Undergraduate Program at Clark University's Becker School of Design & Technology. They has extensive experience as an emergent media artist, game developer, and professor of interactive media. Their work focuses on the intersection of games, artificial intelligence, and XR (Extended Reality) development, particularly in the context of games for change and experimental games for various platforms including PC, mobile, and VR. Professor Ulm's academic background includes a major in computer science from Smith College and graduate studies in interactive programming at Parsons, The New School. They also holds an MFA from Lesley University and continues to engage in creative projects at a local maker-space. Refer to <a href="" target="_blank" rel="noopener noreferrer" style={{ color: '#007bff', textDecoration: 'none' }}>faculty research page</a> for more information.</p>
                            <br />
                        </Fade>
                    </div>
                    <div className='col-md-5'>
