            ...
            <h2 style={{ lineHeight: '1.182em' }}>Computer Science</h2>
                <div className='row'>
                    <div className='col-md-7 mart-top'>
                        <Fade bottom duration={1000}>
                            ...
                            {/* <h2 style={{ lineHeight: '1.182em' }}>Biology Research</h2> */}
                            {/* <p><b>by Javir Tabima Restrepo | Tabima Lab</b></p> */}
                            <p style={{ textAlign: 'justify', marginTop:'20px', lineHeight: '1.667em', color: '#4b5b70', fontSize: '16px', fontWeight: '400' }}>Professor Gary Holness’s professional interests include machine learning, pattern recognition, and artificial intelligence. He is actively involved in research and teaching, with a significant focus on developing innovative approaches in these fields. He has also been involved in various initiatives, such as a course development grant for "Internet of Things for Social Good".  Refer to <a href="https://www.clarku.edu/faculty/profiles/gary-holness/" target="_blank" rel="noopener noreferrer" style={{ color: '#007bff', textDecoration: 'none' }}>Professor Holness's webpage</a> for more information.</p>
                            <br />
                        </Fade>
                    </div>
                    <div className='col-md-5'>
                ...
                <div className='row'>
                    ...
                    <div className='col-md-5'>
                        <div className='row'>
                            <Fade bottom duration={800}>
                                <img src={SN} className='img-re-class margin-top-40' />
                            </Fade>
                        </div>
                    </div>
                </div>
                ...
                <div className='row'>
                    <div className='col-md-7 mart-top'>
                        <Fade bottom duration={1000}>
                            ...
                            {/* <h2 style={{ lineHeight: '1.182em' }}>Biology Research</h2> */}
                            {/* <p><b>by Javir Tabima Restrepo | Tabima Lab</b></p> */}
                            <p style={{ textAlign: 'justify', marginTop:'20px', lineHeight: '1.667em', color: '#4b5b70', fontSize: '16px', fontWeight: '400' }}>Professor Christopher Williams’s expertise is in terrestrial ecosystems, global environmental change, and climate change.   He and his team engage in foundational research science on the climate impacts of forests.  By combining state-of-the-art satellite remote sensing with big data geo-computation, the lab is quantifying the carbon emissions avoided by protecting forests, the removals of carbon with forest growth, and also the important climate impacts of changing surface reflectivity (albedo) that happens with changes in tree cover.  Their work is informing decision makers about where we get the greatest climate benefit from retaining and expanding tree cover, worldwide. Refer to <a href="https://wordpress.clarku.edu/cwilliams/" target="_blank" rel="noopener noreferrer" style={{ color: '#007bff', textDecoration: 'none' }}>Professor Williams’s webpage</a> for more information.</p>
                            <br />
                        </Fade>
                    </div>
                    <div className='col-md-5'>
                ...
                <div className='row'>
                    <div className='col-md-7 mart-top'>
                        <Fade bottom duration={1000}>
                            ...
                            {/* <h2 style={{ lineHeight: '1.182em' }}>Biology Research</h2> */}
                            {/* <p><b>by Javir Tabima Restrepo | Tabima Lab</b></p> */}
                            <p style={{ textAlign: 'justify', marginTop:'20px', lineHeight: '1.667em', color: '#4b5b70', fontSize: '16px', fontWeight: '400' }}>Professor Tim Downs at Clark University specializes in environmental science and engineering, focusing on the interactions between human activities and environmental changes, and their impacts on health, ecosystems, and well-being. His work includes community-centered health system innovation, sustainable development, and environmental justice, using interdisciplinary approaches and collaborating with diverse stakeholders globally. Key projects involve the National Children's Study in Worcester County and community-based interventions for malaria in Kenya. Refer to <a href="https://www.clarku.edu/faculty/profiles/timothy-downs/" target="_blank" rel="noopener noreferrer" style={{ color: '#007bff', textDecoration: 'none' }}>Professor Downs's webpage</a> for more information.</p>
                            <br />
                        </Fade>
                    </div>
                    <div className='col-md-5'>
            ...
            <h2 style={{ lineHeight: '1.182em' }}>Geography</h2>
                <div className='row'>
                    <div className='col-md-7'>
                        <div className='row'>
                            <Fade bottom duration={800}>
                                <img src={Estes} className='img-re-class margin-top-40' />
                            </Fade>
                        </div>
                    </div>
                    <div className='col-md-5 mart-top'>
                        <Fade bottom duration={1000}>
                            ...
                            {/* <h2 style={{ lineHeight: '1.182em' }}>Biology Research</h2> */}
                            {/* <p><b>by Javir Tabima Restrepo | Tabima Lab</b></p> */}
                            <p style={{ textAlign: 'justify', marginTop:'20px', lineHeight: '1.667em', color: '#4b5b70', fontSize: '16px', fontWeight: '400' }}>Professor Lyndon Estes at Clark University focuses on the drivers and impacts of agricultural change in sub-Saharan Africa. His research employs advanced Earth observation technologies and modeling techniques to improve agricultural mapping and sustainability. He leads projects that aim to address food security, analyze farming practices, and develop high-resolution maps of cropland using machine learning and satellite imaging. Estes' work is crucial in understanding how agriculture in Africa is influenced by and adapts to climate change.  Refer to <a href="https://agroimpacts.info/" target="_blank" rel="noopener noreferrer" style={{ color: '#007bff', textDecoration: 'none' }}>Professor Estes's webpage</a> for more information.</p>
                            <br />
                        </Fade>
                    </div>
                </div>
                ...
                <div className='row'>
                    <div className='col-md-7 mart-top'>
                        <Fade bottom duration={1000}>
                            ...
                            {/* <h2 style={{ lineHeight: '1.182em' }}>Biology Research</h2> */}
                            {/* <p><b>by Javir Tabima Restrepo | Tabima Lab</b></p> */}
                            <p style={{ textAlign: 'justify', marginTop:'20px', lineHeight: '1.667em', color: '#4b5b70', fontSize: '16px', fontWeight: '400' }}>Professor Barbara Capogrosso Sansone is engaged in significant research in the field of physics at Clark University. Her work spans various areas, including condensed matter physics, quantum mechanics, and statistical physics. She focuses particularly on theoretical and computational approaches to understanding complex systems, such as quantum many-body systems and materials under extreme conditions. Professor Capogrosso Sansone's research contributes to advancing fundamental understanding in physics and has implications for applications in materials science, quantum technologies, and beyond. Her contributions underscore Clark University's commitment to cutting-edge research in physics and interdisciplinary scientific exploration. Refer to <a href="https://wordpress.clarku.edu/bcapogrosso/" target="_blank" rel="noopener noreferrer" style={{ color: '#007bff', textDecoration: 'none' }}>Professor Sansone's webpage</a> for more information.</p>
                            <br />
                        </Fade>
                    </div>
                    <div className='col-md-5'>
