...
import T10 from "../../images/gsd.png";
import T11 from "../../images/bda.jpg";
  ...
  return (
    <>
      <div className="major-bg-red">
        <Fade bottom duration={800}>
          <div className="text-center">
            <h1 className="h1-content">Minor and Concentrations</h1>
            <p className="p-content">
              Explore the expanding realm of data science with our Data Science
              Minor and specialized concentrations in Business Data Analytics
              (BDA) and Geospatial Data Analytics (GDA), designed to complement
              any major.
            </p>
          </div>
        </Fade>
        ...
        <Fade bottom duration={1000}>
          <div className="row">
            ...
            <div className="col-md-10">
              ...
              <h2 class="display-data">
                About the Minor and Concentrations Program
              </h2>
              <br />
              <p
                className="p-content"
              ...
              >
                ...
                <br />
                <br /> The Data Science Minor equips you with foundational
                knowledge and practical skills that are crucial in today’s
                data-driven world. The BDA concentration focuses on the
                application of data science in business contexts, preparing you
                to make data-driven decisions that propel business strategies
                forward. The GDA concentration offers you the opportunity to
                delve into spatial data analysis, opening doors to careers in
                urban planning, environmental science, and beyond. Whether you
                aim to integrate cutting-edge data analysis techniques into your
                primary field of study or seek to enhance your career prospects,
                these programs provide the knowledge and skills that will help
                you stand out among your peers and position you for future
                success. <br />
                <br />
                Our interdisciplinary approach not only ensures that students
                gain a deep understanding of both theoretical and practical
                aspects but also fosters collaboration among faculty and student
                across various disciplines. Whether your interest lies in
                pursuing graduate studies or applying data science to fields
                such as health informatics, financial analytics, or
                environmental science, our program paves the way for you to
                become a proficient and insightful data science professional.{" "}
              </p>
            </div>
      ...
      <div className="container my-5">
        ...
        <div className="row">
          <div className="col-md-4">
            <CardDesign title={'CSCI 120 - Introduction to Computing'} content={' Introduction to Computing is a foundational course designed to develop computational problem-solving skills through programming while introducing students to various essential topics in computer science.'} image={HCI} onhandleClick={() => {
              setType("IC");
              handleShow();
            }} />
          </div>
          ...
          <div className="col-md-4">
            <CardDesign title={'CSCI 124 - Honors Introduction to Computing'} content={'Honors Introduction to Computing is an accelerated course that provides a comprehensive introduction to computing and its diverse applications.'} image={IC} onhandleClick={() => {
              setType("IC");
              handleShow();
            }} />
          </div>
      ...
      <div className="container-fluid margin-top-40">
        <Fade bottom duration={1000}>
          <div className="row">
            ...
            <div className="col-md-10">
              <div class="line size-150px mg-bottom-28px"></div>
              <h2 class="display-data">Explore Concentrations</h2>
              <br />
              <p
                className="p-content"
                style={{
              ...
              >
                The Data Science program at Clark University offers minor concentration which is designed to complement a variety of major fields, equipping students with valuable skills in data analysis, statistical modeling, and computational thinking.
              </p>
            </div>
            <div className="col-md-2"></div>
          </div>
      ...
      <div className="container mb-4">
        <div class="d-flex flex-column flex-md-row justify-content-center align-items-center gap-3 mt-5">
          <div class="tpn_card">
            ...
            <h5>Geospatial Data Analytics</h5>
            <p>
              The Concentration in Geospatial Data Analytics is designed to equip students with the skills and knowledge needed to analyze and interpret geospatial data effectively.

            </p>
            <div class="btn-container">
              <a
                href="https://catalog.clarku.edu/preview_program.php?catoid=32&poid=6582&returnto=2750"
                class="btn tpn_btn"
          ...
          <div class="tpn_card">
            ...
            <h5>Business Data Analytics</h5>
            <p>
              Business Data Analytics is a concentration that
              combines foundational quantitative and analytics
              skills, programming knowledge, and business and economics applications.
            </p>
            <div class="btn-container">
              <a
                href="https://catalog.clarku.edu/preview_program.php?catoid=32&poid=6582&returnto=2750"
          ...
          <div class="tpn_card" style={{ visibility: 'hidden' }}>
